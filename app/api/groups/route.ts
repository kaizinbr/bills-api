...
export async function POST(request: NextRequest) {
    ...
    const safePayerId = typeof payerId === "string" && payerId.trim() ? payerId : session.user.id;
    const safeReceiverId = typeof receiverId === "string" && receiverId.trim() ? receiverId : session.user.id;
